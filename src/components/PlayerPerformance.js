...
const PlayerPerformance = () => {
  ...
  return (
    <div className="container mt-4 text-white">
      ...
      <div className="performance-card p-4"> {/* ✅ Card added with padding */}
        <h3 className="text-center mb-4">📊 Add Player Performance</h3>
        ...
        <form onSubmit={handleSubmit}>
          ...
          {/* Against Team */}
          <div className="mb-3">
            <label className="form-label">Against Team</label>
            <input
              type="text"
